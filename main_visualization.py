...
#------------------
sys.path.append(os.path.normpath('./visualization/'))
...
[GRFx1_mean,GRFx2_mean, GRFz1_mean, GRFz2_mean,GRFx1_std,GRFx2_std, GRFz1_std, GRFz2_std] = mean_calc.calc_dyn() #hier noch die Pfade anpassen (auslesen über Dialog oder ähnliches (keine Slashes, damit Windowsverträglich))
...
##------------------------------plot VPP boxplot
#plot_means.boxplot_VPP(VPP2_trials,R2_trials)
